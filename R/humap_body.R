...
#'   the appereance of the humap. Currently, only one control is available (more
#'   will follow in the fuuture): \code{na_fill} specificies the fill of
#'   zero-count regions (default: "black").
#'
